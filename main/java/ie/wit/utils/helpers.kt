...
fun uploadImageView(app: BackingTrackApp, imageView: ImageView) {
...
fun writeImageRef(app: BackingTrackApp, imageRef: String) {
...
fun updateAllDonations(app: BackingTrackApp) {
    val userId = app.auth.currentUser!!.uid
...
fun validatePhoto(app: BackingTrackApp, activity: Activity) {
...
fun checkExistingPhoto(app: BackingTrackApp, activity: Activity) {
